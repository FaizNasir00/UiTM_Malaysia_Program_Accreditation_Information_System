    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
        ...
        <script>
            ...
            $('#jenis_permohonan').change(function() {
                ...
                if ($(this).val() == 'IQA05') {
                    $('#sijil_mqa_bm_container').show();
                    $('#sijil_mqa_bi_container').show();
                } else {
                    $('#sijil_mqa_bm_container').hide();
                    $('#sijil_mqa_bi_container').hide();
                }
            });
        });
...
<body>
	...
	<div id="box" class="box">
		<form id="myForm" action="connect3.php" method="POST">
            ...
            <input type="text" id="nama_program_bm" name="nama_program_bm" style="text-transform: uppercase;">
            
            <label for="nama_program_bi">Nama Program (BI)</label><br><br>
            <input type="text" id="nama_program_bi" name="nama_program_bi" style="text-transform: uppercase;">
            ...
            <div id="kod_nec_container">
                <input type="integer" id="kod_nec_1" name="kod_nec_1" maxlength="1" class="kod-nec-input">
                <input type="integer" id="kod_nec_2" name="kod_nec_2" maxlength="1" class="kod-nec-input">
                <input type="integer" id="kod_nec_3" name="kod_nec_3" maxlength="1" class="kod-nec-input">
                <input type="integer" id="kod_nec_4" name="kod_nec_4" maxlength="1" class="kod-nec-input">
            </div><br><br>
    		...
    		<label id="no_rujukan_mqa" for="no_rujukan_mqa"> Nombor Rujukan MQA </label><br><br>
    		<input type="text" id="no_rujukan_mqa" name="no_rujukan_mqa" ><br>
    		
    		<div id="sijil_mqa_bm_container" style="display:none;">
                <label for="sijil_mqa_bm">Sijil MQA BM:</label>
                <input type="file" id="sijil_mqa_bm" name="sijil_mqa_bm">
            </div><br><Br>
            
            <div id="sijil_mqa_bi_container" style="display:none;">
                <label for="sijil_mqa_bi">Sijil MQA BI:  </label>
                <input type="file" id="sijil_mqa_bi" name="sijil_mqa_bi">
            </div><br><br>
           ...
           <select name="institusi_luar4" id="institusi_luar4">
    		...
    		<label for="status_permohonan">Status</label><br><br>
