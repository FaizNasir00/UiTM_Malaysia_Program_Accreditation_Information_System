...
<html>
<head>
	<title>Maklumat Panel Luar</title>
	<meta charset="UTF-8">
...
<body>
		...
		<div class="big-box">
			<form method="post" action="connect4.php">
				...
				<div class="input-box" style="opacity: 0.0;">
                        ...
                        <input type="text" value="Panel Luar" name="jenis_panel" class="input-field" readonly>
                        </div>
	...
	<a href="panel1.php"><button style="position: fixed; top : 20px; right: 20px;">Refresh</button></a>
